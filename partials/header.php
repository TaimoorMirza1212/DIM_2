...
if(isset($_SESSION['login']) && $_SESSION['login'] =='loged_in'){
				...
				<div class="top-menu">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							...
							<img alt="" class="img-circle " src="assets/img/<?php echo $_SESSION['profile_img'];?>" />
								<span class="username username-hide-on-mobile">Balance $99 </span>
